...
type Womens_Bureau_of_SriLanka_Props = NativeStackScreenProps<RootStackPramList,"Womens_Bureau_of_SriLanka">

const Womens_Bureau_of_SriLanka = ({navigation}: Womens_Bureau_of_SriLanka_Props) => {
    ...
    return (
        <SafeAreaView style={{flex:1}}>
            ...
            />
            <Text style= {styles.Heading_text}>Womens Bureau of SriLanka</Text>
            </View >
...
export default Womens_Bureau_of_SriLanka
