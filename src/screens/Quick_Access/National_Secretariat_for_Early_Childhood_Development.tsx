...
type National_Secretariat_for_Early_Childhood_Development_Props = NativeStackScreenProps<RootStackPramList,"National_Secretariat_for_Early_Childhood_Development">

const National_Secretariat_for_Early_Childhood_Development = ({navigation}: National_Secretariat_for_Early_Childhood_Development_Props) => {
    ...
    return (
        <SafeAreaView style={{flex:1}}>
            ...
            />
            <Text style= {styles.Heading_text}>National Secretariat for{'\n'}Early Childhood Development</Text>
            </View >
            ...
            <View style={{flex:1}}>
                    ...
                    <View style={styles.content_bg} >
                        <View style={{flexDirection:'row', marginTop: 20,marginHorizontal:30}}>
                            ...
                            <TouchableOpacity style={styles.Call_Button} onPress={()=>openURL("tel:0112186054")} disabled={!canOpenTel_1}>
                                <Image
                                ...
                                <Text style={styles.Normal_Text_White}>0112186054</Text>
                            </TouchableOpacity>
                            
                        </View>
                        <View style={{flexDirection:'row', marginTop: 20,marginHorizontal:30}}>
                            <Text style={styles.Normal_Text}>     Fax : </Text>
                            <TouchableOpacity style={styles.Call_Button} onPress={()=>openURL("tel:0112187277")} disabled={!canOpenTel_2}>
                                <Image
                                    source={require('../../../assets/fax.png')}
                                    style={{marginLeft:10,marginRight:12,width: 25, height: 25, }} // Adjust the width and height as needed
                                    />
                                
                                <Text style={styles.Normal_Text_White}>0112187277</Text>
                            </TouchableOpacity>
                        </View>
...
export default National_Secretariat_for_Early_Childhood_Development
