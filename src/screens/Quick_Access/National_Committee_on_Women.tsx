...
type National_Committee_on_Women_Props = NativeStackScreenProps<RootStackPramList,"National_Committee_on_Women">

const National_Committee_on_Women = ({navigation}: National_Committee_on_Women_Props) => {
    ...
    return (
        <SafeAreaView style={{flex:1}}>
            ...
            />
            <Text style= {styles.Heading_text}>National Committee on Women</Text>
            </View >
            ...
            <View style={{flex:1}}>
                    ...
                    <View style={styles.content_bg} >
                        <View style={{flexDirection:'row', marginTop: 20,marginHorizontal:30}}>
                            ...
                            <TouchableOpacity style={styles.Call_Button} onPress={()=>openURL("tel:0112187248")} disabled={!canOpenTel_1}>
                                <Image
                                ...
                                <Text style={styles.Normal_Text_White}>0112187248</Text>
                            </TouchableOpacity>
                            
                        </View>
                        <View style={{flexDirection:'row', marginTop: 20,marginHorizontal:30}}>
                            <Text style={styles.Normal_Text}>     Fax : </Text>
                            <TouchableOpacity style={styles.Call_Button} onPress={()=>openURL("tel:0112827091")} disabled={!canOpenTel_2}>
                                <Image
                                    source={require('../../../assets/fax.png')}
                                    style={{marginLeft:10,marginRight:12,width: 25, height: 25, }} // Adjust the width and height as needed
                                    />
                                
                                <Text style={styles.Normal_Text_White}>0112827091</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={{flexDirection:'row',flexWrap:'wrap', marginTop: 20,marginHorizontal:30}}>
                            ...
                            <TouchableOpacity style={styles.Mail_Button} onPress={()=>openURL("mailto:ncw@childwomenmin.gov.lk")} disabled={!canOpenEmail}>
                                <Image
                                    ...
                                    />
                                <Text style={styles.Normal_Text_White_2}>ncw@childwomenmin.{"\n"}gov.lk</Text>
                            </TouchableOpacity>
...
export default National_Committee_on_Women
