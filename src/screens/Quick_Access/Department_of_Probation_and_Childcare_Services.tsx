...
type Department_of_Probation_and_Childcare_Services_Props = NativeStackScreenProps<RootStackPramList,"Department_of_Probation_and_Childcare_Services">

const Department_of_Probation_and_Childcare_Services = ({navigation}: Department_of_Probation_and_Childcare_Services_Props) => {
    ...
    return (
        <SafeAreaView style={{flex:1}}>
            ...
            />
            <Text style= {styles.Heading_text}>Department of Probation{'\n'}and Childcare Services</Text>
            </View >
            ...
            <View style={{flex:1}}>
                    ...
                    <View style={styles.content_bg} >
                        <View style={{flexDirection:'row', marginTop: 20,marginHorizontal:30}}>
                            ...
                            <TouchableOpacity style={styles.Call_Button} onPress={()=>openURL("tel:0112186062")} disabled={!canOpenTel_1}>
                                <Image
                                ...
                                <Text style={styles.Normal_Text_White}>0112186062</Text>
                            </TouchableOpacity>
                            
                        </View>
                        <View style={{flexDirection:'row', marginTop: 20,marginHorizontal:30}}>
                            <Text style={styles.Normal_Text}>     Fax : </Text>
                            <TouchableOpacity style={styles.Call_Button} onPress={()=>openURL("tel:0112187285")} disabled={!canOpenTel_2}>
                                <Image
                                    source={require('../../../assets/fax.png')}
                                    style={{marginLeft:10,marginRight:12,width: 25, height: 25, }} // Adjust the width and height as needed
                                    />
                                
                                <Text style={styles.Normal_Text_White}>0112187285</Text>
                            </TouchableOpacity>
                        </View>
                        ...
                        <View style={{flexDirection:'row', marginTop: 20,marginHorizontal:15}}>
                            ...
                            <Text style={styles.Normal_Text}>3rd Floor,{"\n"}Sethsiripaya Stage II,{"\n"}Battaramulla,{"\n"}Sri Lanka. </Text>
                        </View>
...
export default Department_of_Probation_and_Childcare_Services
